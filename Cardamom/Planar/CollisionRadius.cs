    ...
    public class CollisionRadius : Collision
    {
        ...
        public CollisionRadius(ParseBlock Block)
        {
            foreach (ParseBlock B in Block.Break())
            {
                ...
                {
                    case "center": _Center = Cardamom.Interface.ClassLibrary.Instance.ParseVector2f(B.String); break;
                    case "radius": _Radius = Convert.ToDouble(B.String, System.Globalization.CultureInfo.InvariantCulture); break;
                }
            }
        }
