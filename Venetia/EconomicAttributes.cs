...
namespace Venetia
{
	public class EconomicAttributes
	{
		...
		public EconomicAttributes(
			double Coefficient, double Exponent, double Decay, double Supply, double Demand, double LivingStandard)
		{
		...
		public override string ToString()
		{
			return string.Format(
				"[EconomicAttributes: Coefficient={0}, Exponent={1}, Decay={2}, Supply={3}, Demand={4}, "
				+ "LivingStandard={5}, IncomeReduction={6}]",
				Coefficient, Exponent, Decay, Supply, Demand, LivingStandard, IncomeReduction);
		}
	}
}
